  ...
  return (
    <div className="container">
      <div className='flex gap-5 mt-28 md:mt-24'>
        <div className='flex flex-col justify-center items-center my-10 md:mt-4 md:mb-0 mx-72 md:mx-48'>
          <form className='flex flex-col gap-5'>
            ...
            <div className="relative w-full">
              <textarea 
                className="top-0 left-0 w-full h-48 md:h-24 bg-gray-100 rounded-lg p-5 text-gray-700 placeholder-gray-500 border border-gray-400 resize-none" 
          ...
          <div className='overflow-hidden'>
            <div className='relative'>
              <img src={Winter} alt="Winter aespa" className='w-[470.5px] md:w-[350px] object-cover'/>
            </div>
          </div>
      </div>
    </div>
