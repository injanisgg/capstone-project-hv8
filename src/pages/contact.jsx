...
function Contact() {
  ...
  return (
    <div className="pb-24">
      ...
      <div className={`flex flex-col lg:flex-row gap-5 mt-36 ${isLoggedin ? 'xl:mt-24' : 'xl:mt-28'}`}>
        <div className='flex flex-col justify-center items-center 1xl:my-5 xl:mt-4 xl:mb-0 1xl:mx-42 xl:mx-48'>
          <form className='flex flex-col items-center gap-5'>
            ...
            <input
              type="text"
              className="form-input w-80 mx-5 xl:w-96 1xl:w-full bg-gray-100 rounded-lg py-3 pl-5 pr-4 text-gray-700 placeholder-gray-500 border border-gray-400"
              placeholder="Name"
            />
            <input
              type="text"
              className="form-input w-80 mx-5 bg-gray-100 rounded-lg py-3 pl-5 pr-4 text-gray-700 placeholder-gray-500 border border-gray-400"
              placeholder="Email"
            />
            <div className="relative w-full">
              <textarea 
                className="lg:top-0 lg:left-0 w-80 mx-8 1xl:h-32 xl:h-24 bg-gray-100 rounded-lg p-5 text-gray-700 placeholder-gray-500 border border-gray-400 resize-none" 
                placeholder="Write messages you want to tell us"
              />
            </div>
            <button className="rounded-lg w-80 1xl:w-full bg-main-yellow h-10 font-semibold">Send</button>
          </form>
        </div>
