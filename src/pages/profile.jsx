...
function Profile() {
  ...
  return (
    ...
    {/*header*/}
    <header>
      <div className='flex justify-between lg:mx-20 xl:mx-16 my-5 lg:my-2 items-center'>
    ...
    <form action="" className='flex justify-center mt-4 gap-12'>
      <div className="flex flex-col gap-7 lg:gap-4">
        <span className='flex flex-col'>
          ...
          className={`form-input xl:w-[30rem] lg:w-80 bg-gray-100 rounded-lg py-3 pl-5 pr-4 ${profile.name.firstname && profile.name.lastname ? 'text-black' : 'text-gray-500'} placeholder-gray-500 border border-gray-400`}/>
        </span>
        <span className='flex flex-col'>
          ...
          value={`${profile.email}`}
          className={`form-input xl:w-[30rem] lg:w-80 bg-gray-100 rounded-lg py-3 pl-5 pr-4 ${profile.email ? 'text-black' : 'text-gray-500'} placeholder-gray-500 border border-gray-400`}/>
        </span>
        <span className='flex flex-col'>
          ...
          className={`form-input xl:w-[30rem] lg:w-80 bg-gray-100 rounded-lg py-3 pl-5 pr-4 ${gender ? 'text-black' : 'text-gray-500'} placeholder-gray-500 border border-gray-400`}/>
        </span>
      </div>
      <div className="flex flex-col gap-7 lg:gap-4">
        <span className='flex flex-col'>
          ...
          value={`${profile.phone}`}
          className={`form-input xl:w-[30rem] lg:w-80 bg-gray-100 rounded-lg py-3 pl-5 pr-4 ${profile.phone ? 'text-black' : 'text-gray-500'} placeholder-gray-500 border border-gray-400`}/>
        </span>
        <span className='flex flex-col'>
          ...
          className={`form-input xl:w-[30rem] lg:w-80 bg-gray-100 rounded-lg py-3 pl-5 pr-4 ${profile.username ? 'text-black' : 'text-gray-500'} placeholder-gray-500 border border-gray-400`}/>
        </span>
        <span className='flex flex-col'>
          ...
          className={`form-input xl:w-[30rem] lg:w-80 bg-gray-100 rounded-lg py-3 pl-5 pr-4 ${profile.password ? 'text-black' : 'text-gray-500'} placeholder-gray-500 border border-gray-400`}/>
        </span>
      </div>
      <div className="flex flex-col">
        <label htmlFor="" className='text-main-army font-bold'>Address</label>
        <textarea 
          className="top-0 left-0 w-96 lg:w-80 h-64 lg:h-56 bg-gray-100 rounded-lg p-5 text-gray-700 placeholder-gray-500 border border-gray-400 resize-none" 
