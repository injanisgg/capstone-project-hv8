...
function About() {
  return (
    <div className="container mx-auto">
      ...
      <div className='flex flex-col justify-center items-center my-16 lg:my-0 lg:pt-12 lg:mx-52 xl:mx-20'>
        <h1 className="lg:text-4xl xl:text-3xl text-main-army font-bold pr-[7rem] self-start">MON.CHÉRIE</h1>
        ...
        <div className="flex flex-col items-center">
            <span className="lg:text-4xl xl:text-2xl font-bold text-main-army">200+</span>
        ...
        <div className="flex flex-col items-center">
            <span className="lg:text-4xl xl:text-2xl font-bold text-main-army">2,000+</span>
            <span className="ml-2 lg:text-sm text-gray-600">High-Quality Products</span>
        </div>
        <div className="border-l border-gray-300 h-12 mx-4"></div>
        <div className="flex flex-col items-center">
            <span className="lg:text-4xl xl:text-2xl font-bold text-main-army">30,000+</span>
        ...
        <div className='overflow-hidden'>
          <div className='relative'>
            <img src={Rose} alt="Rose Blackpink" className='lg:w-[410px] xl:w-[360px] xl:pt-7' />
          </div>
        </div>
    </div>
    </div>
