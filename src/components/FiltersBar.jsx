...
function FiltersBar() {
  return (
    <div>
      <div className='bg-white rounded-3xl w-[295px] h-[1420px] border border-slate-300'>
        {/* content */}
        <div className='mx-6 my-6'>
            ...
            {/* Basic filter */}
            <div className="border-b-2 border-gray-300 w-[15.3rem] my-6"></div>
            ...
            <button className="rounded-3xl bg-main-yellow w-56 h-10 font-semibold ml-2 my-4">Apply Filters</button>
        </div>
      </div>
    </div>
  )
