...
function FiltersBar() {
  ...
  return (
    <div>
        {/* filter lg */}
      <div className='hidden lg:block w-[250px] bg-white rounded-3xl xl:w-[295px] 1xl:w-[260px] xl:h-[1420px] 1xl:h-[1550px] border border-slate-300' id='filterSidebar'>
        {/* content */}
        <div className='mx-6 my-6'>
            ...
            <div className='flex flex-col gap-5 mt-5 items-center'>
                ...
                />
                <i class="fa-solid fa-grip-lines-vertical text-main-army"></i>
                <input
                    type="text"
                    className="form-input w-56 bg-gray-100 rounded-lg py-1 pl-5 pr-4 text-gray-700 placeholder-gray-500 border border-gray-400 text-center"
            ...
            <div className='my-6'>
                <button className="mr-4 mb-4 bg-gray-100 rounded-full py-3 px-4 text-gray-700 placeholder-gray-500 focus:outline-none">XX-Small</button>
                <button className="mr-4 mb-4 bg-gray-100 rounded-full py-3 px-4 text-gray-700 placeholder-gray-500 focus:outline-none">X-Small</button>
                <button className="mr-4 mb-4 bg-gray-100 rounded-full py-3 px-4 text-gray-700 placeholder-gray-500 focus:outline-none">Small</button>
                <button className="mr-4 mb-4 bg-gray-100 rounded-full py-3 px-4 text-gray-700 placeholder-gray-500 focus:outline-none">Medium</button>
                <button className="mr-4 mb-4 bg-gray-100 rounded-full py-3 px-4 text-gray-700 placeholder-gray-500 focus:outline-none">Large</button>
                <button className="mr-4 mb-4 bg-gray-100 rounded-full py-3 px-4 text-gray-700 placeholder-gray-500 focus:outline-none">X-Large</button>
                <button className="mr-4 mb-4 bg-gray-100 rounded-full py-3 px-4 text-gray-700 placeholder-gray-500 focus:outline-none">XX-Large</button>
      ...
      {isFilterOpen && (
        <div className='fixed w-60 inset-0 bg-white z-50 overflow-y-auto p-4 lg-hidden'>
            <div className='flex justify-between items-center mb-4'>
                ...
                >
                    <i class="fa-solid fa-xmark text-red-500 fa-lg"></i>
                </button>
            </div>
            {/* Basic filter */}
            <div className="border-b-2 border-gray-300 xl:w-[15.3rem] 1xl:w-52 my-6"></div>
            ...
            <button className="rounded-3xl bg-main-yellow p-2 xl:w-56 1xl:w-48 h-10 font-semibold ml-2 my-4">Apply Filters</button>
        </div>
      )}
    </div>
  )
