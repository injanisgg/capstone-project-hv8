...
function DressStyle() {
  return (
    ...
    <div className='bg-landing mx-20 my-16 rounded-3xl h-[800px] w-max-2xl grid grid-cols-12 grid-rows-12 gap-4'>
        <h1 className='text-main-army font-extrabold text-4xl leading-tight 1xl:col-start-4 1xl:col-span-6 1xl:row-start-2 1xl:ml-[82px] xl:col-start-4 xl:col-span-6 xl:row-start-2 xl:ml-4'>EXPLORE DRESSES BY DESIGN</h1>
