...
function DressStyle() {
  return (
    ...
    <div className='bg-landing mx-20 my-16 rounded-3xl h-[800px] w-max-2xl grid grid-cols-12 grid-rows-12 gap-4'>
        <h1 className='text-main-army font-extrabold text-4xl leading-tight col-start-4 col-span-6 row-start-2 ml-[82px] md:col-start-4 md:col-span-6 md:ml-0'>EXPLORE DRESSES BY DESIGN</h1>
