...
const handleAddToCart = () => {
  ...
  return (
    <>
            ...
            <div className="flex gap-5">
              <div className="flex flex-col justify-evenly">
                {[image, image].map((img, index) => (
                  <div key={index} className="mb-5 xl:w-52 lg:w-36">
                    <CardPicture picture={img}/>
                  </div>
                ))}
              </div>
              <div className="xl:w-[30rem] lg:w-80">
                <CardPicture picture={image} />
              </div>
            </div>
            <div className="flex flex-col gap-2 my-2 mx-2">
              <h1 className="text-main-army font-extrabold xl:text-3xl lg:text-2xl leading-tight">{title}</h1>
              ...
              <div className="flex gap-2">
                ...
                <button className="rounded-3xl xl:w-96 lg:w-80 bg-main-yellow h-10 font-semibold" onClick={handleAddToCart && handleRedirectLogin}>
                  Add to cart
                </button>
               </div>
      ...
      <div className="border-b-2 border-gray-300 mx-20 xl:w-[1380px] lg:w-[1110px] mt-14"></div>
    </>
  );
}
