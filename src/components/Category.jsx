        ...
        return (
            <div
                ...
                <div className="flex flex-col gap-2 my-2 mx-2">
                    ...
                    <button className="rounded-3xl xl:w-56 lg:w-40 bg-main-yellow h-10 font-semibold self-center">Add to cart</button>
                </div>
            </div>
        );
    });
    ...
    return (
        <div className='flex flex-col justify-center items-center mb-6'>
            ...
            {loading ? (    
                ...
                <div className="grid grid-cols-1 grid-rows-1 md:grid-cols-2 xl:grid-cols-4 lg:grid-cols-4 gap-12">
                    {renderList}
                </div>
            )}
            ...
            <div className="border-b-2 border-gray-300 mx-20 xl:w-[1380px] lg:w-[1200px] mt-14"></div>
        </div>
    );  
}
