        ...
        return (
            <div
                ...
                <div className="flex flex-col gap-2 my-2 mx-2">
                    ...
                    <button className="rounded-3xl 1xl:w-56 xl:w-40 bg-main-yellow h-10 font-semibold self-center">Add to cart</button>
                </div>
            </div>
        );
    });
    ...
    return (
        <div className='flex flex-col justify-center items-center mb-6'>
            ...
            {loading ? (    
                ...
                <div className="grid grid-cols-1 grid-rows-1 md:grid-cols-2 1xl:grid-cols-4 xl:grid-cols-4 gap-12">
                    {renderList}
                </div>
            )}
